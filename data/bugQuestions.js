export const BUG_QUESTIONS = [
  ...
  {
    id: 6, title: "変数の未使用初期値",
    description: "入力が空かどうか確認するプログラムです。",
    bugLine: 1,
    bugDescription: '1行目: `Dim flag As Boolean = True` → `Dim flag As Boolean = False`',
    explanation: "flag を True で初期化しているため、ReadLine() が空文字を返しても If ブロックに入らず「入力あり」と判定されます。",
    hint: "初期値が後の条件に影響を与えていませんか？",
    difficulty: "EASY",
    lines: ["Dim flag As Boolean = True","Dim input As String = Console.ReadLine()","","If input = \"\" Then","    flag = False","End If","","Console.WriteLine(\"入力あり: \" & flag)"],
  },
  {
    id: 7, title: "再帰の終了条件",
  ...
  {
    id: 8, title: "整数除算の誤差",
    description: "二つの数の平均を計算するプログラムです。",
    bugLine: 5,
    bugDescription: "5行目: `avg = a / b` → `avg = CDbl(a) / b`",
    explanation: "明示的なキャストなしでは意図が曖昧です。`CDbl(a) / b` とするのが安全です。",
    hint: "aとbの型に注目してください",
    difficulty: "NORMAL",
